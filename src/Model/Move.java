...
public enum Move {
	...
	ACID_ARMOR("Acid Armor", Type.POISON, MoveType.STATUS, (byte)40, -1, (byte)-1),
	AGILITY("Agility", Type.PSYCHIC, MoveType.STATUS, (byte)30, -1, (byte)-1),
	AMNESIA("Amnesia", Type.PSYCHIC, MoveType.STATUS, (byte)20, -1, (byte)-1),
	...
	BARRIER("Barrier", Type.PSYCHIC, MoveType.STATUS, (byte)30, -1, (byte)-1),
	...
	CONVERSION("Conversion", Type.NORMAL, MoveType.STATUS, (byte)30, -1, (byte)-1),
	...
	DEFENSE_CURL("Defense Curl", Type.NORMAL, MoveType.STATUS, (byte)40, -1, (byte)-1),
	...
	DOUBLE_TEAM("Double Team", Type.NORMAL, MoveType.STATUS, (byte)15, -1, (byte)-1),
    ...
    FOCUS_ENERGY("Focus Energy", Type.NORMAL, MoveType.STATUS, (byte)30, -1, (byte)-1),
    ...
    GROWTH("Growth", Type.NORMAL, MoveType.STATUS, (byte)40, -1, (byte)-1),
    GROWL("Growl", Type.NORMAL, MoveType.STATUS, (byte)40, -1, (byte)100),
    ...
    HARDEN("Harden", Type.NORMAL, MoveType.STATUS, (byte)30, -1, (byte)-1),
    ...
    LIGHT_SCREEN("Light Screen", Type.PSYCHIC, MoveType.STATUS, (byte)30, -1, (byte)-1),
    ...
    MEDITATE("Meditate", Type.PSYCHIC, MoveType.STATUS, (byte)40, -1, (byte)-1),
    ...
    METRONOME("Metronome", Type.NORMAL, MoveType.STATUS, (byte)10, -1, (byte)-1),
    MIMIC("Mimic", Type.NORMAL, MoveType.STATUS, (byte)10, -1, (byte)100),
    MINIMIZE("Minimize", Type.NORMAL, MoveType.STATUS, (byte)20, -1, (byte)-1),
    MIRROR_MOVE("Mirror Move", Type.FLYING, MoveType.STATUS, (byte)20, -1, (byte)-1),
    MIST("Mist", Type.ICE, MoveType.STATUS, (byte)30, -1, (byte)-1),
    ...
    RECOVER("Recover", Type.NORMAL, MoveType.STATUS, (byte)10, -1, (byte)-1),
    REFLECT("Reflect", Type.PSYCHIC, MoveType.STATUS, (byte)20, -1, (byte)-1),
    REST("Rest", Type.PSYCHIC, MoveType.STATUS, (byte)10, -1, (byte)-1),
    ...
    SAND_ATTACK("Sand-Attack", Type.GROUND, MoveType.STATUS, (byte)15, -1, (byte)100),
    ...
    SHARPEN("Sharpen", Type.NORMAL, MoveType.STATUS, (byte)30, -1, (byte)-1),
    ...
    SOFTBOILED("Softboiled", Type.NORMAL, MoveType.STATUS, (byte)10, -1, (byte)-1),
    ...
    SPLASH("Splash", Type.NORMAL, MoveType.STATUS, (byte)40, -1, (byte)-1),
    ...
    STRING_SHOT("String Shot", Type.BUG, MoveType.STATUS, (byte)40, -1, (byte)95),
    ...
    SUBSTITUTE("Substitute", Type.NORMAL, MoveType.STATUS, (byte)10, -1, (byte)-1),
    ...
    SWIFT("Swift", Type.NORMAL, MoveType.SPECIAL, (byte)20, 60, (byte)-1),
    SWORDS_DANCE("Swords Dance", Type.NORMAL, MoveType.STATUS, (byte)30, -1, (byte)-1),
    TACKLE("Tackle", Type.NORMAL, MoveType.PHYSICAL, (byte)30, 50, (byte)100),
    TAIL_WHIP("Tail Whip", Type.NORMAL, MoveType.STATUS, (byte)30, -1, (byte)100),
    TAKE_DOWN("Take Down", Type.NORMAL, MoveType.PHYSICAL, (byte)20, 90, (byte)85),
    TELEPORT("Teleport", Type.PSYCHIC, MoveType.STATUS, (byte)20, -1, (byte)-1),
    ...
    TRANSFORM("Transform", Type.NORMAL, MoveType.STATUS, (byte)10, -1, (byte)-1),
	...
	WITHDRAW("Withdraw", Type.WATER, MoveType.STATUS, (byte)40, -1, (byte)-1),
    ...
    Move(String name, Type type, MoveType m, byte pp, int power, byte accuracy, Stat stat) {
        Name = name;
        TYPE = type;
        Move_Type = m;
        Accuracy = accuracy;
    ...
    Move(String name, Type type, MoveType m, byte pp, int power, byte accuracy, Status status, Stat stat) {
        Name = name;
        TYPE = type;
        Move_Type = m;
        Accuracy = accuracy;
